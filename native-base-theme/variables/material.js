...
const isIphoneX =
    ...
    (deviceHeight === 812 ||
        ...
        deviceHeight === 896 ||
        deviceWidth === 896);
// const textScale = global.textScale;
// console.warn('material--',textScale)

const themeColor = '#065394';//'#3F51B5',
// const themeColor = '#000';//'#3F51B5',
...
export default {
    ...
    black3: '#999999',
    gray2: '#DDDDDD',
    plan_new: 'rgba(230,246,231,0.8)',

    // chat
    chat_day_bg: '#fff',
    chat_reply_color: '#999',
    chat_reply_bg: '#f3f3f3',
    ...
    // Footer
    footerHeight: 65,
    footerDefaultBg: '#FFF',//底部Footer背景色
    ...
    tabActiveBgColor: '#FFF',//选中的tab背景色

    // Header
    toolbarBtnColor: themeColor,//'#3F51B5',
    toolbarDefaultBg: '#FFF',//标题栏背景色
    toolbarHeight: isIphoneX ? 35 : 46,
    toolbarSearchIconSize: 23,
    toolbarInputColor: '#FFF',
    searchBarHeight: platform === PLATFORM.IOS ? 30 : 40,
    searchBarInputHeight: platform === PLATFORM.IOS ? 40 : 50,
    toolbarBtnTextColor: themeColor,//标题栏 左右 文字颜色
