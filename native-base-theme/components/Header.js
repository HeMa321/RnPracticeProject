...
export default (variables /* : * */ = variable) => {
    ...
    const headerTheme = {
        ...
        'NativeBase.Left': {
            'NativeBase.Button': {
                '.hasText': {
                    ...
                    'NativeBase.Text': {
                        color: variables.toolbarBtnTextColor,
                        fontSize: variables.toolbarBtnTextSize,
                        marginLeft: 2,
                        lineHeight: 19.5
                    },
                    'NativeBase.IconNB': {
        ...
        height:
            variables.platform === PLATFORM.IOS && variables.isIphoneX&&
            variables.platformStyle === PLATFORM.MATERIAL
        ...
        top: variables.platform === PLATFORM.IOS && !variables.isIphoneX ? 0 : 0,
        left: 0,
        right: 0
    };
